    ...
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input value="{{ old('code', $product->code) }}" type="text" name="code" id="code"
                    class="mt-1 block w-full p-2 border rounded-md focus:ring-[#580B0C] focus:border-[#580B0C] text-sm text-[#580B0C]">
            ...
            {{-- <div>
                ...
                <input value="{{ old('description', $product->description) }}" type="text" name="description" id="description"
                    class="mt-1 block w-full p-2 border rounded-md focus:ring-[#580B0C] focus:border-[#580B0C] text-sm text-[#580B0C]">
            ...
            <div>
                <label for="dropzone-file{{ $product->id }}" id="drop-area"
                    ...
                    <input id="dropzone-file{{ $product->id }}" type="file" class="hidden" name="image"
